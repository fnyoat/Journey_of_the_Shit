...
(function(): void {
    ...
    class HatePanel {
        ...
        private _currentEnemyIndex: number;
        ...
        setCurrentEnemyIndex(index: number): void {
...
`;
    ...
    (window as any).fnyoat.HatePanel = {
        open: () => hatePanel.open(),
        close: () => hatePanel.close(),
        isOpen: () => hatePanel.isOpen(),
        setEnemyIndex: (index: number) => hatePanel.setEnemyIndex(index),
