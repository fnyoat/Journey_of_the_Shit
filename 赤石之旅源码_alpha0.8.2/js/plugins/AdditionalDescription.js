 ...
 * @param ButtonName
 * @text 切换按钮名称
 * @desc 切换帮助按钮名称(shift/control/tab)
 * @default shift
 *
 * @param KeyCode
 * @text 键码
 * @desc 想要使用按钮名中指定以外的按钮时，请在这里直接记述键码。
 * @default 0
 *
 * @param ChangePage
 * @text 右下角显示名
 * @desc 窗口右下角显示的页面切换签名字符串。控制字符可用
 * @default Shift键翻页
 *
 * @param ValidTouch
 * @text 左键单击也可切换
 * @desc 触摸帮助窗口or 左键单击也可以切换窗口。
 * @default ON
 *
 * @help 
 这个插件可以在RPG Maker MV帮助窗口中添加第二页内容，
 用于显示额外的描述信息。

 基本功能
 在物品/技能/装备等的帮助窗口中添加第二页描述
 通过按键切换主描述和附加描述
 支持静态文本和动态脚本两种附加描述方式
 *
 静态文本描述
 在物品、技能等的备注栏中添加以下任意一种标签：
 
  <ADDescription:此处为附加说明文本>
 

 动态脚本示例
 在脚本中可以使用item变量引用当前物品对象：
