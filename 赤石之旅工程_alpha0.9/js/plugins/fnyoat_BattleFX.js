...
(function () {
    ...
    Game_Battler.prototype.setBattleSprite = function (sprite) {
        this._battleSprite = sprite;
    };
    Game_Battler.prototype.getBattleSprite = function () {
    ...
    const easeBattler = (b) => {
        ...
        if (b._lastHp === undefined)
            b._lastHp = b.hp;
        if (b._lastMp === undefined)
            b._lastMp = b.mp;
        if (b._lastTp === undefined)
            b._lastTp = b.tp;
        ...
        if (Math.abs(b.hp - b._displayHp) < 0.75)
            b._displayHp = b.hp;
        if (Math.abs(b.mp - b._displayMp) < 0.75)
            b._displayMp = b.mp;
        if (Math.abs(b.tp - b._displayTp) < 0.75)
            b._displayTp = b.tp;
        if (Math.abs(b.hp - b._deepDisplayHp) < 0.75)
            b._deepDisplayHp = b.hp;
        if (Math.abs(b.mp - b._deepDisplayMp) < 0.75)
            b._deepDisplayMp = b.mp;
        if (Math.abs(b.tp - b._deepDisplayTp) < 0.75)
            b._deepDisplayTp = b.tp;
    ...
    Game_Battler.prototype.displayHp = function () {
    ...
    const _BattleFX_Window_Base_drawGauge = Window_Base.prototype.drawGauge;
    ...
    const _BattleFX_Window_Base_drawActorHp = Window_Base.prototype.drawActorHp;
    Window_Base.prototype.drawActorHp = function (actor, x, y, width) {
        ...
        actor.hpRate = function () { return displayHpRate; };
    ...
    const _BattleFX_Window_Base_drawActorMp = Window_Base.prototype.drawActorMp;
    Window_Base.prototype.drawActorMp = function (actor, x, y, width) {
        ...
        actor.mpRate = function () { return displayMpRate; };
    ...
    const _BattleFX_Window_Base_drawActorTp = Window_Base.prototype.drawActorTp;
    Window_Base.prototype.drawActorTp = function (actor, x, y, width) {
        ...
        actor.tpRate = function () { return displayTpRate; };
    ...
    const Window_BattleStatus = window.Window_BattleStatus;
    ...
    Sprite_Damage.prototype.setup = function (target) {
        ...
        if (!result)
            return;
        const hitConfig = window.HitCoreConfig || { blockText: 'Block', parryText: 'Parry', deflectText: 'Deflect' };
        ...
        if ((result.blocked || result.parried || result.deflected) && result.hpDamage === 0) {
            var text;
            if (result.blocked)
                text = hitConfig.blockText;
            else if (result.parried)
                text = hitConfig.parryText;
            else
                text = hitConfig.deflectText;
    ...
    if (!config.virtualBar.enabled)
        return;
    class Sprite_VirtualBar extends Sprite {
        constructor(battler, barType, layer, color, offsetY) {
            super();
        ...
        updateRate() {
            ...
            switch (this._barType) {
                case 0:
                    targetRate = this._battler.displayHpRate();
                    break;
                case 1:
                    targetRate = this._battler.displayMpRate();
                    break;
                case 2:
                    targetRate = this._battler.displayTpRate();
                    break;
            }
    ...
    class Sprite_VirtualText extends Sprite {
        constructor(battler, barType, offsetY, fontSize, infoMode) {
            super();
            this._battler = battler;
            this._barType = barType;
            this._offsetY = offsetY;
        ...
        checkUpdate() {
            ...
            switch (this._barType) {
                case 0:
                    currentValue = this._battler.displayHp();
                    break;
                case 1:
                    currentValue = this._battler.displayMp();
                    break;
                case 2:
                    currentValue = Math.round(this._battler.displayTp());
                    break;
            }
        ...
        getText() {
            ...
            switch (this._barType) {
                case 0:
                    current = this._battler.displayHp();
                    max = this._battler.mhp;
                    break;
                case 1:
                    current = this._battler.displayMp();
                    max = this._battler.mmp;
                    break;
                case 2:
                    current = this._battler.displayTp();
                    max = 100;
                    break;
            }
            if (this._infoMode === 'none')
                return '';
    ...
    const _BattleFX_Sprite_Battler_initMembers = Sprite_Battler.prototype.initMembers;
    Sprite_Battler.prototype.initMembers = function () {
        _BattleFX_Sprite_Battler_initMembers.call(this);
        this._vgfWindow = null;
        this._vgfWindowBeing = false;
    };
    const _BattleFX_Sprite_Battler_update = Sprite_Battler.prototype.update;
    Sprite_Battler.prototype.update = function () {
        _BattleFX_Sprite_Battler_update.call(this);
        this.updateVirtualGroup();
    };
    Sprite_Battler.prototype.updateVirtualGroup = function () {
